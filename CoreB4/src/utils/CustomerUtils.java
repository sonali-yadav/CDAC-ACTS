...
public class CustomerUtils {
	...
	// 2. client sends the name of city. server sends back list of customer from
	// specified city sorted as per dob.
	public static ArrayList<Customer> getCustomersByCity(HashMap<String, Customer> custMap, String city) {
		...
		for (Customer customer : al) {
			if (customer.getAddress().equals(city)) {
				temp.add(customer);
			}
		}
		return temp;
	...
	public static HashMap<String, Customer> populateData() {
		...
		cmap.put("k@gmail", new Customer("k@gmail", "112233", "Pune", "1122335", LocalDate.parse("1998-09-20")));
		cmap.put("a@gmail", new Customer("a@gmail", "445566", "Mumbai", "1133445", LocalDate.parse("1998-08-16")));
		cmap.put("b@gmail", new Customer("b@gmail", "010101", "Pune", "1133445", LocalDate.parse("1998-07-12")));
		cmap.put("c@gmail", new Customer("c@gmail", "121212", "Mumbai", "2233445", LocalDate.parse("1998-06-08")));
		return cmap;
	}
}
