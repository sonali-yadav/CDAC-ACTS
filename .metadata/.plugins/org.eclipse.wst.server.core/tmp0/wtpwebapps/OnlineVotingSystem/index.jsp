...
<jsp:useBean id="voterbean" class="voterbeans.VoterBean" scope="session" />
<jsp:useBean id="candbean" class="voterbeans.CandidateBean" scope="session" />
...
<body class="text-center" style="background-color: #2B7DE9;">
	...
	<div class="main_box">
		<form method="post"
			...
			method="GET" action="validate.jsp">
